...
export const getCoordinates = createSelector(getGetGeolocationStore as any, (state: AppStateGeolocation) => state.geolocation);
export const getIsFetchedGeolocation = createSelector(getGetGeolocationStore as any, (state: AppStateGeolocation) => state.fetchedGeolocation);
